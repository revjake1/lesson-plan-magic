...
```yaml
version: "0.3.5"            # schema version — used for future migrations
...
```yaml
defaults:
  output_formats: [docx]                          # v0.3.5 ships docx only; pdf and google-doc are planned
...
## Framework IDs (v0.3.5 supported)
