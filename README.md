...
[![Version](https://img.shields.io/badge/version-0.3.5-028090?style=flat-square)](https://github.com/revjake1/lesson-plan-magic/releases)
...
Current limits in `v0.3.5`: no PDF export, no native Google Forms creation, and no direct LMS posting. Exit tickets can produce Google Forms-ready `.txt`, but the actual form or LMS post is still manual.
...
defaults:
  output_formats: [docx]       # v0.3.5 ships docx only; pdf is on the roadmap
...
*Jake's Lesson Plan Magic · v0.3.5 · [jakehallman.com](https://jakehallman.com)*
