...
[![Version](https://img.shields.io/badge/version-0.3.1-028090?style=flat-square)](https://github.com/revjake1/lesson-plan-magic/releases)
...
Current limits in `v0.3.1`: no PDF export, no native Google Forms creation, and no direct LMS posting. Exit tickets can produce Google Forms-ready `.txt`, but the actual form or LMS post is still manual.
...
*Jake's Lesson Plan Magic · v0.3.1 · [jakehallman.com](https://jakehallman.com)*
